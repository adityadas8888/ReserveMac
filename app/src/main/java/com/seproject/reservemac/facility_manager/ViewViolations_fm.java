...
import com.seproject.reservemac.ui.common.ViolationModel;
...
public class ViewViolations_fm extends AppCompatActivity implements GetRequests.AsyncResponse {
    ...
    private void loadViolationsArray() {
        ...
        stringBuilder.append("user/view_violation.php?username=").append(usr);
        String url = stringBuilder.toString();
        new GetRequests(ViewViolations_fm.this, url, ViewViolations_fm.this, "ViewViolation").execute("");
